...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/permissions/privapp-permissions-org.lineageos.oppo.imsinit.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/privapp-permissions-org.lineageos.oppo.imsinit.xml
...
PRODUCT_COPY_FILES += \
    ...
    prebuilts/vndk/v32/arm64/arch-arm-armv8-a/shared/vndk-sp/libhidlbase.so:$(TARGET_COPY_OUT_VENDOR)/lib/libhidlbase_v32.so \
    prebuilts/vndk/v32/arm64/arch-arm64-armv8-a/shared/vndk-sp/libhidlbase.so:$(TARGET_COPY_OUT_VENDOR)/lib64/libhidlbase_v32.so \
